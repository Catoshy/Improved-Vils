...
public class VilAttributes {
	...
	public static void apply(EntityVillager e) 
	{
		...
		e.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(ConfigHandlerVil.villagerHealth);
		e.getAttributeMap().getAttributeInstance(SharedMonsterAttributes.ARMOR).setBaseValue(ConfigHandlerVil.villagerBaseArmour);
	}
